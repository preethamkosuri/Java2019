...
public class TestJUnit {
  ...
  public void testCase1() {
    ...
    Assert.assertEquals(1, bst.get(new Book("Algorithms","Bob Sedgewick",6000.0)));
    ...
    bst.deleteMin();
    Assert.assertEquals(2, bst.get(new Book("IT","Viswas",400.0)));
...
@Test
  public void testCase2() {
    ...
    bst.deleteMax();
    Assert.assertEquals(6, bst.get(new Book("Street","Kiran",800.0)));
    bst.put(new Book("Hello","Ajay",200.0),5);
    ...
    Assert.assertEquals(5, bst.get(new Book("Hello","Ajay",200.0)));
    Assert.assertEquals("Hello", bst.min().title);
    bst.put(new Book("Hello","Ajay",200.0),7);
    Assert.assertEquals(7, bst.get(new Book("Hello","Ajay",200.0)));
